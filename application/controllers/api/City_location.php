...
class City_location extends REST_Controller {
    /**
    ...
    */
    public function __construct() {
     ...
     public function add_city_post() {
        ...
        if(!empty($city_id) &&  !empty($sub_admin_id)){
...
public function delete_location_delete($id='') {
        ...
        if(!empty($id) ){
              ...
              if($userCount){
                  // Set the response and exit
                     if($this->Crud_model->delete('cities_and_sub_admin',$con)){
                      // Set the response and exit
                      $this->response([
                          'status' => TRUE,
 ...
 public function fetch_all_location_get() {
           ...
           $option = array(
               'select' => 'cities_and_sub_admin.*,cities.city,sub_admin.name',
...
public function fetch_from_state_id_get($state_id=0) {     
        ...
        if(!empty($state_id) ){
              ...
              $userCount = $this->Crud_model->getRows('cities',$con,'result');

              if($userCount){
                  // Set the response and exit
                    $this->response([
                          'status' => TRUE,
                          "message" => "Cities load successfully.",
                          "data" => $userCount
                      ], REST_Controller::HTTP_OK);
                  // Check if the user data is inserted
