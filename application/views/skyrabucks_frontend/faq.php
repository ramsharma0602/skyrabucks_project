                ...
                <div class="col-12">
                    <div class="slider-4-2 product-wrapper">
                        <div>
                            <div class="faq-top-box">
                                <div class="faq-box-icon">
                                    <img src="<?php echo base_url()?>assets/images/inner-page/faq/start.png" class="blur-up lazyload"
                                        alt="">
                                </div>
                        ...
                        <div>
                            <div class="faq-top-box">
                                <div class="faq-box-icon">
                                    <img src="<?php echo base_url()?>assets/images/inner-page/faq/help.png" class="blur-up lazyload" alt="">
                                </div>
                        ...
                        <div>
                            <div class="faq-top-box">
                                <div class="faq-box-icon">
                                    <img src="<?php echo base_url()?>assets/images/inner-page/faq/price.png" class="blur-up lazyload"
                                        alt="">
                                </div>
                        ...
                        <div>
                            <div class="faq-top-box">
                                <div class="faq-box-icon">
                                    <img src="<?php echo base_url()?>assets/images/inner-page/faq/contact.png" class="blur-up lazyload"
                                        alt="">
                                </div>
                    ...
                    <div class="faq-contain">
                        ...
                        <p>We are answering most frequent questions. No worries if you not find exact one. You can find
                            out more by searching or continuing clicking button below or directly <a
                                href="contact_us" class="theme-color text-decoration-underline">contact our
                                support.</a></p>
                    </div>
                </div>
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingOne">
                                    <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                        ...
                                        What is Skyrabucks and why was the name changed? <i
                                ...
                                <div id="collapseOne" class="accordion-collapse collapse show"
                                    ...
                                    <div class="accordion-body">
                                        <p>Skyrabucks is leading the charge in transforming India’s vast, unorganised
                                        ...
                                        <p>To know the reason why we changed our brand name from Grofers to Skyrabucks,
...
<!-- Mirrored from themes.pixelstrap.com/Skyrabucks/front-end/faq by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 13 Apr 2023 08:04:29 GMT -->
