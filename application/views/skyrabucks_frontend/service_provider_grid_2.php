            ...
            <div class="row g-4">
                <div class="col-xxl-4 col-md-6">
                    <div class="seller-grid-box seller-grid-box-1">
                        <div class="grid-image">
                            <div class="image">
                                <img src="<?php echo base_url()?>assets/images/vendor-page/logo/1.png" class="img-fluid" alt="">
                            </div>
                        ...
                        <div class="grid-contain">
                            ...
                            <div class="seller-category">
                                ...
                                <ul class="product-image">
                                    <li>
                                        <img src="<?php echo base_url()?>assets/images/vegetable/product/6.png" class="img-fluid" alt="">
                                    </li>
                                    <li>
                                        <img src="<?php echo base_url()?>assets/images/vegetable/product/3.png" class="img-fluid" alt="">
                                    </li>
                                    <li>
                                        <img src="<?php echo base_url()?>assets/images/vegetable/product/1.png" class="img-fluid" alt="">
                                    </li>
                                    <li>
                                        <img src="<?php echo base_url()?>assets/images/vegetable/product/9.png" class="img-fluid" alt="">
                                    </li>
                                    <li>
                                        <img src="<?php echo base_url()?>assets/images/vegetable/product/1.png" class="img-fluid" alt="">
                                    </li>
                ...
                <div class="col-xxl-4 col-md-6">
                    <div class="seller-grid-box seller-grid-box-1">
                        <div class="grid-image">
                            <div class="image">
                                <img src="<?php echo base_url()?>assets/images/vendor-page/logo/2.png" class="img-fluid" alt="">
                            </div>
                ...
                <div class="col-xxl-4 col-md-6">
                    <div class="seller-grid-box seller-grid-box-1">
                        <div class="grid-image">
                            <div class="image">
                                <img src="<?php echo base_url()?>assets/images/vendor-page/logo/3.png" class="img-fluid" alt="">
                            </div>
                ...
                <div class="col-xxl-4 col-md-6">
                    <div class="seller-grid-box seller-grid-box-1">
                        <div class="grid-image">
                            <div class="image">
                                <img src="<?php echo base_url()?>assets/images/vendor-page/logo/4.png" class="img-fluid" alt="">
                            </div>
                ...
                <div class="col-xxl-4 col-md-6">
                    <div class="seller-grid-box seller-grid-box-1">
                        <div class="grid-image">
                            <div class="image">
                                <img src="<?php echo base_url()?>assets/images/vendor-page/logo/5.png" class="img-fluid" alt="">
                            </div>
                ...
                <div class="col-xxl-4 col-md-6">
                    <div class="seller-grid-box seller-grid-box-1">
                        <div class="grid-image">
                            <div class="image">
                                <img src="<?php echo base_url()?>assets/images/vendor-page/logo/6.png" class="img-fluid" alt="">
                            </div>
                ...
                <div class="col-xxl-4 col-md-6">
                    <div class="seller-grid-box seller-grid-box-1">
                        <div class="grid-image">
                            <div class="image">
                                <img src="<?php echo base_url()?>assets/images/vendor-page/logo/7.png" class="img-fluid" alt="">
                            </div>
...
<!-- Mirrored from themes.pixelstrap.com/fastkart/front-end/seller-grid-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 13 Apr 2023 08:03:56 GMT -->
