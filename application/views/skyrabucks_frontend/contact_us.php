                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                <div class="contact-image">
                                    <img src="<?php echo base_url()?>assets/images/inner-page/contact-us.png"
                                    ...
                                    <div class="row g-4">
                                        <div class="col-xxl-6 col-lg-12 col-sm-6">
                                            <div class="contact-detail-box">
                                                ...
                                                <div class="contact-detail-contain">
                                                    <!-- <p>(+1) 618 190 496</p> -->
                                                    <?php echo($general_settings[6]->value)?>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xxl-6 col-lg-12 col-sm-6">
                                            <div class="contact-detail-box">
                                                ...
                                                <div class="contact-detail-contain">
                                                    ...
                                                    <?php echo($general_settings[2]->value)?>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xxl-6 col-lg-12 col-sm-6">
                                            <div class="contact-detail-box">
                                                ...
                                                <div class="contact-detail-contain">
                                                <?php echo($general_settings[14]->value)?>
                                                </div>
                                            </div>
                                        </div>
...
<!-- Mirrored from themes.pixelstrap.com/fastkart/front-end/contact-us by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 13 Apr 2023 08:04:03 GMT -->
