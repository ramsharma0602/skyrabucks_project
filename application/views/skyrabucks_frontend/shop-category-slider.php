<title>Shop category slider</title>
                    ...
                    <div class="slider-7_1 no-space shop-box no-arrow">
                            ...
                            <div class="shop-category-box">
                                <a href="shop-left-sidebar">
                                    <div class="shop-category-image">
                                        <img src="<?php echo base_url()?>assets/svg/1/vegetable.svg" class="blur-up lazyload" alt="">
                                    </div>
                        ...
                        <div>
                            <div class="shop-category-box">
                                <a href="shop-left-sidebar">
                                    <div class="shop-category-image">
                                        <img src="<?php echo base_url()?>assets/svg/1/cup.svg" class="blur-up lazyload" alt="">
                                    </div>
                                    <div class="category-box-name">
                                        <h6>Beverages</h6>
                                    </div>
                        ...
                        <div>
                            <div class="shop-category-box">
                                <a href="shop-left-sidebar">
                                    <div class="shop-category-image">
                                        <img src="<?php echo base_url()?>assets/svg/1/meats.svg" class="blur-up lazyload" alt="">
                                    </div>
                                    <div class="category-box-name">
                                        <h6>Meats & Seafood</h6>
                                    </div>
                        ...
                        <div>
                            <div class="shop-category-box">
                                <a href="shop-left-sidebar">
                                    <div class="shop-category-image">
                                        <img src="<?php echo base_url()?>assets/svg/1/breakfast.svg" class="blur-up lazyload" alt="">
                                    </div>
                                    <div class="category-box-name">
                                        <h6>Breakfast</h6>
                                    </div>
                        ...
                        <div>
                            <div class="shop-category-box">
                                <a href="shop-left-sidebar">
                                    <div class="shop-category-image">
                                        <img src="<?php echo base_url()?>assets/svg/1/frozen.svg" class="blur-up lazyload" alt="">
                                    </div>
                                    <div class="category-box-name">
                                        <h6>Frozen Foods</h6>
                                    </div>
                        ...
                        <div>
                            <div class="shop-category-box">
                                <a href="shop-left-sidebar">
                                    <div class="shop-category-image">
                                        <img src="<?php echo base_url()?>assets/svg/1/milk.svg" class="blur-up lazyload" alt="">
                                    </div>
                                    <div class="category-box-name">
                                        <h6>Milk & Dairies</h6>
                                    </div>
                        ...
                        <div>
                            <div class="shop-category-box">
                                <a href="shop-left-sidebar">
                                    <div class="shop-category-image">
                                        <img src="<?php echo base_url()?>assets/svg/1/pet.svg" class="blur-up lazyload" alt="">
                                    </div>
                                    <div class="category-box-name">
                                        <h6>Pet Food</h6>
                                    </div>
                        ...
                        <div>
                            <div class="shop-category-box">
                                <a href="shop-left-sidebar">
                                    <div class="shop-category-image">
                                        <img src="<?php echo base_url()?>assets/svg/1/biscuit.svg" class="blur-up lazyload" alt="">
                                    </div>
                                    <div class="category-box-name">
                        ...
                        <div>
                            <div class="shop-category-box">
                                <a href="shop-left-sidebar">
                                    <div class="shop-category-image">
                                        <img src="<?php echo base_url()?>assets/svg/1/grocery.svg" class="blur-up lazyload" alt="">
                                    </div>
                                    <div class="category-box-name">
                                ...
                                <div class="product-header">
                                    <div class="product-image">
                                        <a href="product_detail">
                                            <img src="<?php echo base_url()?>uploads/Category_Images/<?php echo $value->main_image?>"
...
<!-- Mirrored from themes.pixelstrap.com/fastkart/front-end/shop-category-slider by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 13 Apr 2023 08:03:45 GMT -->
