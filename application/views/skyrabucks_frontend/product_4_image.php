                        ...
                        <div class="row g-sm-4 g-2">
                            <div class="col-6 col-grid-box wow fadeInUp">
                                <div class="slider-image">
                                    <img src="<?php echo base_url()?>assets/images/product/category/1.jpg" id="img-1"
                                        data-zoom-image="<?php echo base_url()?>assets/images/product/category/1.jpg" class="
                            ...
                            <div class="col-6 col-grid-box wow fadeInUp" data-wow-delay="0.05s">
                                <div class="slider-image">
                                    <img src="<?php echo base_url()?>assets/images/product/category/2.jpg" id="img-2"
                                        data-zoom-image="<?php echo base_url()?>assets/images/product/category/2.jpg" class="
                            ...
                            <div class="col-6 col-grid-box wow fadeInUp" data-wow-delay="0.1s">
                                <div class="slider-image">
                                    <img src="<?php echo base_url()?>assets/images/product/category/3.jpg" id="img-3"
                                        data-zoom-image="<?php echo base_url()?>assets/images/product/category/3.jpg" class="
                            ...
                            <div class="col-6 col-grid-box wow fadeInUp" data-wow-delay="0.15s">
                                <div class="slider-image">
                                    <img src="<?php echo base_url()?>assets/images/product/category/4.jpg" id="img-4"
                                        data-zoom-image="<?php echo base_url()?>assets/images/product/category/4.jpg" class="
                                                        img-fluid image_zoom_cls-3 blur-up lazyload" alt="">
                                </div>
                            </div>

                            <div class="col-6 col-grid-box wow fadeInUp" data-wow-delay="0.2s">
                                <div class="slider-image">
                                    <img src="<?php echo base_url()?>assets/images/product/category/5.jpg" id="img-5"
                                        data-zoom-image="<?php echo base_url()?>assets/images/product/category/5.jpg" class="
                            ...
                            <ul>
                                <li>
                                    <a href="javascript:void(0)">
                                        <img src="<?php echo base_url()?>assets/images/product/payment/1.svg" class="blur-up lazyload"
                                            alt="">
                                    </a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)">
                                        <img src="<?php echo base_url()?>assets/images/product/payment/2.svg" class="blur-up lazyload"
                                            alt="">
                                    </a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)">
                                        <img src="<?php echo base_url()?>assets/images/product/payment/3.svg" class="blur-up lazyload"
                                            alt="">
                                    </a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)">
                                        <img src="<?php echo base_url()?>assets/images/product/payment/4.svg" class="blur-up lazyload"
                                            alt="">
                                    </a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)">
                                        <img src="<?php echo base_url()?>assets/images/product/payment/5.svg" class="blur-up lazyload"
                                            alt="">
                                    </a>
                                </li>
                            </ul>
                                ...
                                <div class="product-header">
                                    <div class="product-image">
                                        <a href="product-left-2">
                                            <img src="<?php echo base_url()?>assets/images/cake/product/11.png"
                                                class="img-fluid blur-up lazyload" alt="">
                                        </a>
...
<!-- Mirrored from themes.pixelstrap.com/fastkart/front-end/product-4-image by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 13 Apr 2023 08:03:49 GMT -->
