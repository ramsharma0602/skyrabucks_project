                ...
                <div class="col-xxl-4 order-lg-2">
                    <div class="poster-box">
                        <div class="poster-image">
                            <img src="<?php echo base_url()?>assets/images/vendor-page/become-saller.svg" class="img-fluid" alt="">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="seller-title h-100 d-flex align-items-center">
                        <div>
                            ...
                            <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque
                                laudantium,On the other hand, we denounce with righteous indignation and dislike men who
        ...
        <div class="container-fluid-lg">
            ...
            <form>
                <div class="row">
                    ...
                    <div class="col-12">
                        <button class="btn btn-md mt-3 theme-bg-color text-white">Start Selling</button>
                    </div>
                </div>
            </form>
        </div>
...
<!-- Mirrored from themes.pixelstrap.com/fastkart/front-end/seller-become.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 13 Apr 2023 08:03:51 GMT -->
