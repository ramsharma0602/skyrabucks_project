    ...
    <footer class="section-t-space">
        <div class="container-fluid-lg">
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="footer-logo">
                            <div class="theme-logo">
                                <a href="index">
                                    <img src="<?php echo base_url()?>assets/images/logo/1.png" class="blur-up lazyload" alt="">
                                </a>
                            </div>
                                    ...
                                    <ul>
                                        <li class="mb-0">
                                            <a href="https://play.google.com/store/apps" target="_blank">
                                                <img src="<?php echo base_url()?>assets/images/playstore.svg" class="blur-up lazyload"
                                                    alt="">
                                            </a>
                                        </li>
                                        <li class="mb-0">
                                            <a href="https://www.apple.com/in/app-store/" target="_blank">
                                                <img src="<?php echo base_url()?>assets/images/appstore.svg" class="blur-up lazyload"
                                                    alt="">
                                            </a>
                                        </li>
                                    </ul>
            ...
            <div class="sub-footer section-small-space">
                ...
                <div class="payment">
                    <img src="<?php echo base_url()?>assets/images/payment/1.png" class="blur-up lazyload" alt="">
                </div>
...
<!-- Mirrored from themes.pixelstrap.com/fastkart/front-end/about-us.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 13 Apr 2023 08:04:27 GMT -->
</html>