    ...
    <div class="container-fluid">
      ...
      <div class="row">
         <div class="col-lg-12" style="padding: 10px;">
          ...
          <a href="<?php echo base_url('Super_admin/add_product') ?>" class="btn btn-outline-primary btn-sm"><i class="fa fa-plus-circle"></i>
         Create Product</a>
...
$('#product_body').on('change','#is_seasonal', function() {

   var $this = $( this ),
        job_id = $this.val();
        $.ajax({
          url:"<?php echo base_url('api/Product/change_is_seasonal/');?>"+job_id,
          method:"post",
          async: false,
          dataType: 'json',  
            success:function(response){
...
$('#product_body').on('change','#is_day_to_day', function() {

   var $this = $( this ),
        job_id = $this.val();
        $.ajax({
          url:"<?php echo base_url('api/Product/change_is_day_to_day/');?>"+job_id,
          method:"post",
          async: false,
          dataType: 'json',  
            success:function(response){
                    ...
                    var images=response.files;
                        ...
                        for (x =0 ; x<data.length; x++) {
                         var i=x+1
                              ...
                              if (data[x].is_seasonal=='Y') {

                              $seasonal ='<label class="switch">'+
                              '<input type="checkbox"  id="is_seasonal"  value="'+data[x].job_id+'" checked>'+
                              '<span class="slider round"></span>'+
                              '</label>'+
                              '</span>';
                              }
                              ...
                              $seasonal ='<label class="switch">'+
                              '<input type="checkbox" href="javascript:;" value="'+data[x].job_id+'" id="is_seasonal" >'+
                              '<span class="slider round"></span>'+
                              '</label>'+
                              '</span>';
                              }

                              if (data[x].is_day_to_day=='Y') {

                              $day_to_day ='<label class="switch">'+
                              '<input type="checkbox"  id="is_day_to_day"  value="'+data[x].job_id+'" checked>'+
                              '<span class="slider round"></span>'+
                              '</label>'+
                              '</span>';
                              }
                              ...
                              $day_to_day ='<label class="switch">'+
                              '<input type="checkbox" href="javascript:;" value="'+data[x].job_id+'" id="is_day_to_day" >'+
                              '<span class="slider round"></span>'+
                              '</label>'+
                              '</span>';
                              }
                             ...
                             html+='<tr '+quantity_zero+' >'+
                                  ...
                                  '<td>'+'<a  style="margin: 5px;" href="<?php echo base_url('Super_admin/product_specification/'); ?>'+data[x].job_id+'" class="btn btn-sm btn-outline-secondary"><i class="fas fa-plus-circle"></i> Specification</a>'+'</td>'+
                                  // '<td>'+'<a style="margin: 5px;" href="<?php echo base_url('Admin/product_feature/'); ?>'+data[x].job_id+'" class="btn btn-sm btn-outline-primary"><i class="fas fa-plus-circle"></i> Feature</a>'+'</td>'+
                                  '<td>'+
                                  '<a href="<?php echo base_url('Super_admin/edit_products/'); ?>'+data[x].job_id+'" style="margin: 5px;" class="btn btn-sm btn-outline-primary item-edit" data="'+data[x].job_id+'"><i class="fas fa-edit"></i></a>'
                                  +'</td>'+
