...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div class="form-group">
    <label for="exampleFormControlSelect2">Super Admin Name</label>
   <input type="text" name="name" class="form-control" placeholder="First name">
  </div>
  <div class="form-group">
    <label for="exampleFormControlSelect2">Super Admin Email</label>
   <input type="text" name="email" class="form-control" placeholder="Email">
  </div>
  <div class="form-group">
    <label for="exampleFormControlSelect2">Super Admin Phone</label>
...
$(function(){  
  ...
  $('#btnadd').click(function(){
    ...
    $('#myform').attr('action','<?php echo base_url(); ?>api/Owner/update_super_admin');

      $.ajax({
        type: 'ajax',
        method: 'get',
        url: '<?php echo base_url(); ?>api/Owner/super_admin',
        async: false,
        dataType: 'json',
                ...
                success: function(response) {
                    ...
                    data=response.data;
                        ...
                        html+=  '<table class="table table-bordered"><tr>'+
                                    '<td><b> Super Admin Name :</b></td>'+
                                    '<td>'+data.name+'</td>'+
                               
                              '</tr>';
                        html+=    '<tr>'+
                                '<td ><b>Super Admin Email :</b></td>'+
                                    '<td>'+data.email+'</td>'
                              '</tr></table>';    

                        html+=    '<tr>'+
                                '<td ><b>Super Admin Mobile :</b></td>'+
                                    '<td>'+data.mobile+'</td>'
                              '</tr></table>';    
