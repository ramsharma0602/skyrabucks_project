...
$(function showallData(){ 
  showallData();
          ...
          $('#myform').attr('action','<?php echo base_url(); ?>api/State_Location/Add_states');
      });
...
$('#brand_data').on('change','#is_active', function() {
   ...
   var $this = $( this ),
        id = $this.val();
        $.ajax({
          url:"<?php echo base_url('api/State_Location/states_is_active/');?>"+id,
          method:"POST",
          async: false,
          dataType: 'json',  
            success:function(response){
...
$('#brand_data').on('click','.item-delete',function(){
    ...
    $('#btdelete').unbind().click(function(){
        $.ajax({
            ...
            method: 'delete',
            async: false,
            url: '<?php echo base_url(); ?>api/State_Location/delete_states/'+id,
            data: {id: id},
            dataType: 'json',
            success: function(response)
            {
