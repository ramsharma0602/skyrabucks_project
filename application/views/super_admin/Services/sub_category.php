...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <form id="myform">
      <div class="modal-body">
            ...
            <div class="form-group">
               <label for="exampleFormControlSelect2">Sub Service Name</label>
               <input type="text" name="sub_service_name" class="form-control" placeholder="sub service name">
            </div>

            <!-- <input type="hidden" name="sub_service_name"> -->
                <div class="form-group">
                    <label for="exampleFormControlSelect2">Main Service Name</label>
                </div>
