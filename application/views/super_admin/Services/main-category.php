   ...
   $(function(){ 
    ...
    showallData();
      ...
      $('#btnadd').click(function(){
          $('#myform')[0].reset();
           $('#btnSave').html('Submit');
          $('#exampleModal').find('.modal-title').text('Add Service');
          $('#myform').attr('action','<?php echo base_url(); ?>api/Main_category/add_service');
      });
...
$('#main_category_data').on('click','.item-delete2',function(){
    ...
    $('#myModal_for_delete_message2').find('.modal-title').text('Delete Service Image ');
    ...
    $('#btdelete2').unbind().click(function(){
        $.ajax({
            ...
            method: 'delete',
            async: false,
            url: '<?php echo base_url(); ?>api/Main_category/delete_service_image/'+id,
            data: {id: id},
            dataType: 'json',
            success: function(response)
            {
...
$('#main_category_data').on('click','.item-delete',function(){
    ...
    $('#myModal_for_delete_message').find('.modal-title').text('Delete Service');
    $('#myModal_for_delete_message').modal('show');
    ...
    $('#btdelete').unbind().click(function(){
        $.ajax({
            ...
            method: 'delete',
            async: false,
            url: '<?php echo base_url(); ?>api/Main_category/delete_service/'+id,
            data: {id: id},
            dataType: 'json',
            success: function(response)
            {
