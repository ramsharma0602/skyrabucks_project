       ...
       <div class="col-xl-3 col-lg-6">
            <div class="card card-inverse card-danger" style=" overflow: hidden;" >
              <div class="card-block bg-danger" style="z-index: 8; float: right;  height: 100%;">
                 <a href="<?php echo base_url('Admin_control/Sell');?>">  
                <div class="rotate">
          ...
          <div class="col-xl-3 col-lg-6">
            <div class="card card-inverse card-danger" style=" overflow: hidden;" >
              ...
              <div class="card-block bg-success" style="z-index: 8; float: right;  height: 100%;">
                    <a href="<?php echo base_url('Admin_control/all_products');?>">
                <div class="rotate">
                  <i class="fa fa-list fa-4x" style="color: rgba(20, 20, 20, 0.15); position: absolute;left: 0; left: auto;  right: -10px; bottom: 0; display: block;  -webkit-transform: rotate(-44deg);  -moz-transform: rotate(-44deg); -o-transform: rotate(-44deg); -ms-transform: rotate(-44deg); transform: rotate(-44deg);"></i>
                </div>
                ...
                <h3 class="display-3" style="color:white; padding:20px;"><?php echo $this->db->get_where('jobs',array('is_deleted =' => 'N'))->num_rows(); ?></h3>
             </a>
              </div>
        ...
        <div class="col-xl-3 col-lg-6">
            <div class="card card-inverse card-danger" style=" overflow: hidden;" >
              <div class="card-block bg-info" style="z-index: 8; float: right;  height: 100%;">
                  <a href="<?php echo base_url('Admin_control/customer');?>">  
                  <div class="rotate">
                  <i class="fa fa-list fa-4x" style="color: rgba(20, 20, 20, 0.15); position: absolute;left: 0; left: auto;  right: -10px; bottom: 0; display: block;  -webkit-transform: rotate(-44deg);  -moz-transform: rotate(-44deg); -o-transform: rotate(-44deg); -ms-transform: rotate(-44deg); transform: rotate(-44deg);"></i>
                </div>
                 <h6 class="text-uppercase" style="color:white; padding:20px;">Total Users</h6>
                <h3 class="display-3" style="color:white; padding:20px;"><?php echo $this->db->get_where('customer')->num_rows(); ?></h3>
               </a>
               </div>
            </div>
          </div>
          <div class="col-xl-3 col-lg-6">
            <div class="card card-inverse card-danger" style=" overflow: hidden;" >
              <div class="card-block bg-secondary" style="z-index: 8; float: right;  height: 100%;">
                  <a href="<?php echo base_url('Admin_control/todays_sale');?>">  
                  <div class="rotate">
                  <i class="fa fa-list fa-4x" style="color: rgba(20, 20, 20, 0.15); position: absolute;left: 0; left: auto;  right: -10px; bottom: 0; display: block;  -webkit-transform: rotate(-44deg);  -moz-transform: rotate(-44deg); -o-transform: rotate(-44deg); -ms-transform: rotate(-44deg); transform: rotate(-44deg);"></i>
                </div>
                 <h6 class="text-uppercase" style="color:white; padding:20px;">Today's Sale
                 <?php $sale= $this->db->get_where('order_details')->result(); $todays_sale=0;
                     foreach($sale as $sale_row => $sale_val){
                         if(date('Y-m-d',strtotime($sale_val->order_date))==date('Y-m-d')){
                             $todays_sale=$todays_sale+1;
                         }
                     }
                 ?>
                 </h6>
                 <h3 class="display-3" style="color:white; padding:20px;"><?php echo $todays_sale;?></h3> 
                <!-- <h3 class="display-3" style="color:white; padding:20px;"><?php echo $this->db->get_where('order_details')->num_rows(); ?></h3> -->
               </a>
               </div>
            </div>
...
$.ajax({
          url:"<?php echo base_url().('api/States_and_super_admin/fetch_state/');?>"+state_id,
          method:"get",
          async: false,
          dataType: 'json',  
...
function all_location(){
    $.ajax({
          url:"<?php echo base_url().('api/States_and_super_admin/fetch_state');?>",
          method:"get",
          async: false,
          dataType: 'json',  
            success:function(response){
