...
<main class="page-content">
    <div class="container-fluid" id="product_body">
         <div class="row">
            ...
            <div class="col-md-2">
                <a href="<?php echo base_url('Service_Provider/all_products') ?>" class="btn btn-outline-primary btn-sm" style="float:right;"><i class="fa fa-list"> </i> Job Lists</a>
            </div>
      <hr>
     ...
     $.ajax({
        ...
        success: function(response){
           ...
           sub_service_id=data.sub_service_id;
            $('textarea[name=sort_description]').val(data.sort_description);
