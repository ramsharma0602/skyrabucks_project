...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div class="form-group">
    <label for="exampleFormControlSelect2">Service provider Phone</label>
...
$(function(){  
  ...
  $('#btnadd').click(function(){
    ...
    $('#myform').attr('action','<?php echo base_url(); ?>api/Owner/update_service_provider');

      $.ajax({
        type: 'ajax',
        method: 'get',
        url: '<?php echo base_url(); ?>api/Owner/service_provider',
        async: false,
        dataType: 'json',
                ...
                success: function(response) {
                    ...
                    data=response.data;
                        ...
                        html+=  '<table class="table table-bordered"><tr>'+
                              ...
                              '</tr>';
                        html+=    '<tr>'+
                                '<td ><b>Service provider Email :</b></td>'+
                                    '<td>'+data.email+'</td>'
                              '</tr></table>';    

                        html+=    '<tr>'+
                                '<td ><b>Service provider Mobile :</b></td>'+
                                    '<td>'+data.mobile+'</td>'
                              '</tr></table>';    
