    ...
    <div class="container-fluid">
      ...
      <div class="row">
         <div class="col-lg-12" style="padding: 10px;">
          ...
          <a href="<?php echo base_url('Admin/add_product') ?>" class="btn btn-outline-primary btn-sm"><i class="fa fa-plus-circle"></i>
         Create Product</a>
                        ...
                        for (x =0 ; x<data.length; x++) {
                         var i=x+1
                             ...
                             html+='<tr '+quantity_zero+' >'+
                                  ...
                                  '<td>'+'<a  style="margin: 5px;" href="<?php echo base_url('Admin/product_specification/'); ?>'+data[x].job_id+'" class="btn btn-sm btn-outline-secondary"><i class="fas fa-plus-circle"></i> Specification</a>'+'</td>'+
                                  ...
                                  '<td>'+
                                  '<a href="<?php echo base_url('Admin/edit_products/'); ?>'+data[x].job_id+'" style="margin: 5px;" class="btn btn-sm btn-outline-primary item-edit" data="'+data[x].job_id+'"><i class="fas fa-edit"></i></a>'
                                  +'</td>'+
