...
<main class="page-content">
  ...
  <div class="card-body" id="admin_data">
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div class="form-group">
   ...
   <input type="integer" name="mobile" class="form-control" placeholder="Sub Admin Phone number">
  </div>
</form>
      </div>
...
$(function(){  
  ...
  $('#btnadd').click(function(){
    ...
    $('#myform').attr('action','<?php echo base_url(); ?>api/Owner/update_sub_admin');

      $.ajax({
        type: 'ajax',
        method: 'get',
        url: "<?php echo base_url()?>api/Owner/sub_admin",
        async: false,
        dataType: 'json',
                ...
                success: function(response) {
                    ...
                    data=response.data;
                        ...
                        html+=  '<table class="table table-bordered"><tr>'+
                                    '<td><b>Sub Admin Name :</b></td>'+
                                    '<td>'+data.name+'</td>'+
                               
                              '</tr>';
                        html+=    '<tr>'+
                                '<td ><b>Sub Admin Email :</b></td>'+
                                    '<td>'+data.email+'</td>'
                              '</tr></table>';    

                        html+=    '<tr>'+
                                '<td ><b>Sub Admin mobile :</b></td>'+
                                    '<td>'+data.mobile+'</td>'
                              '</tr></table>';    
