...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div class="form-group">
    <label for="exampleFormControlSelect2">Delivery Partner Phone</label>
...
$(function(){  
  ...
  $('#btnadd').click(function(){
    ...
    $('#myform').attr('action','<?php echo base_url(); ?>api/Owner/update_delivery_partner');

      $.ajax({
        type: 'ajax',
        method: 'get',
        url: '<?php echo base_url(); ?>api/Owner/delivery_partner',
        async: false,
        dataType: 'json',
                ...
                success: function(response) {
                    ...
                    data=response.data;
                        ...
                        html+=  '<table class="table table-bordered"><tr>'+
                                    '<td><b>Delivery Partner Name :</b></td>'+
                                    '<td>'+data.name+'</td>'+
                               
                              '</tr>';
                        html+=    '<tr>'+
                                '<td ><b>Delivery Partner Email :</b></td>'+
                                    '<td>'+data.email+'</td>'
                              '</tr></table>';    

                        html+=    '<tr>'+
                                '<td ><b>Delivery Partner Mobile :</b></td>'+
                                    '<td>'+data.mobile+'</td>'
                              '</tr></table>';    
