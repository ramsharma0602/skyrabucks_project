...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div class="form-group">
    <label for="exampleFormControlSelect2"> Admin Phone</label>
...
$(function(){  
  ...
  $('#btnadd').click(function(){
    ...
    $('#myform').attr('action','<?php echo base_url(); ?>api/Owner/update_admin');

      $.ajax({
        type: 'ajax',
        method: 'get',
        url: '<?php echo base_url(); ?>api/Owner/admin',
        async: false,
        dataType: 'json',
