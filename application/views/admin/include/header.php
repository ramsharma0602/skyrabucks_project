      ...
      <div class="sidebar-menu">
        ...
        <li class="sidebar-dropdown">
            ...
            <div class="sidebar-submenu">
              <ul>
                <li>
                    <a href="<?php echo base_url('Admin/Sub_admin/'); ?>">Sub Admin</a>
                  </li>
                <li>
                  <a href="<?php echo base_url('Admin/Support_team/'); ?>">Support team </a>
                </li>
                <li>
                  <a href="<?php echo base_url('Admin/Service_provider/'); ?>">Service Provider </a>
                </li>
                <li>
                  <a href="<?php echo base_url('Admin/delivery_partner/'); ?>">Delivery Partner </a>
                </li>
                <li>
        ...
        <li>
            <a href="<?php echo base_url('Admin/Sell/'); ?>">
        ...
        <li>
            <a href="<?php echo base_url('Admin/todays_sale/'); ?>">
              <i class="fas fa-coins"></i>
              <span>Earning</span>
            </a>
        </li>
          <li>
            <a href="<?php echo base_url('Admin/Return_order/'); ?>">
        ...
        <li>
            <a href="<?php echo base_url('Admin/Canceled_product'); ?>">
